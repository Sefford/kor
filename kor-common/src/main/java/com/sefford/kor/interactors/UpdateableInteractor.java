 ...
 * it has to stop.
 * <p/>
 * Each of the loops will terminate in a call to {@link com.sefford.kor.interactors.interfaces.InteractorNotification#notifySuccess(com.sefford.kor.responses.ResponseInterface) notifySuccess}
 * if no unexpected condition happened.
 * <p/>
 * Otherwise, it will produce a {@link com.sefford.kor.interactors.interfaces.InteractorNotification#notifyError(com.sefford.kor.errors.ErrorInterface)}  notifyError} response.
 *
 * @author Saul Diaz <sefford@gmail.com>
 */
public class UpdateableInteractor<R extends ResponseInterface, E extends ErrorInterface> extends NetworkInteractor<R, E> {
