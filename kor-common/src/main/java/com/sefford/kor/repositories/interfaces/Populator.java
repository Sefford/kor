...
/**
 * Abstraction of a tool to optionally populate {@link com.sefford.kor.repositories.LruRepository LRU Repositories}
 *
 * @param <K> Type of the IDs of the Repository.
 * @author Saúl Díaz <sefford@gmail.com>
 */
public interface Populator<K> {
