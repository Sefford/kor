...
```groovy
dependencies {
    compile 'com.sefford:kor-usecases:4.2.1'
    compile 'com.sefford:kor-repositories:4.2.1'
    compile 'com.sefford:kor-repositories-extensions:4.2.1' // optional 
    compile 'com.sefford:kor-repositories-gson-converter:4.2.1' 
    compile 'com.sefford:kor-repositories-moshi-converter:4.2.1'
}
```
